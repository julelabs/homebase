...
- Wochenplan: Knopf "<Tag> auf Mo bis Fr übernehmen" kopiert Morgens, Mittags und Abends des gewählten Tages auf alle Werktage des gewählten Kindes, Aktivitäten bleiben pro Tag (Aktion `wp-copy-weekdays`).
...
4. Feiersound auf dem iPad prüfen (Web-Inspector per Kabel), sonst Sound streichen.
